...
public class MixinTileEntityGeoGenerator
{
	private static final int newEnergyCapacity = ConfigUtil.getInt(IC2EnergyFixConfig.get(), "balance/generator/geothermal/energyCapacity");
	private static final int newFluidTankCapacity = ConfigUtil.getInt(IC2EnergyFixConfig.get(), "balance/generator/geothermal/fluidTankCapacity");
